...
public class custCredModel {
    ...
    private Timestamp custLastLoginDate;
    ...
    public custCredModel( String custName, String custMobile, 
                        String custLocation, String custEmail, String custAddress,
                        String custSAddress, String custPincode,
                        Timestamp custLastLoginDate, String custPassword) {
